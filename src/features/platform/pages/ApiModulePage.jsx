...
const moduleConfig = {
  ...
  '/rpl/applications': {
    title: 'طلبات الاعتراف بالخبرة',
    eyebrow: 'RPL',
    icon: ClipboardList,
    description: 'طلبات البرامج المتاحة في API، وهي أقرب عقدة تشغيلية حالية لطلبات المسارات.',
    endpoints: [{ label: 'طلبات البرامج', request: () => fetchAdminApplications({ per_page: 10 }) }],
  },
  '/rpl/evidence': {
    title: 'الأدلة المهنية',
    eyebrow: 'RPL',
    icon: FileText,
    description: 'ملف التسليم لا يتضمن endpoint مستقل للأدلة المهنية؛ يتم عرض طلبات البرامج كمصدر مرتبط.',
    endpoints: [{ label: 'طلبات البرامج', request: () => fetchAdminApplications({ per_page: 10 }) }],
  },
  '/rpl/assessments': {
    ...
    eyebrow: 'RPL',
    icon: BadgeCheck,
    description: 'لا يوجد endpoint تقييم RPL مستقل في التسليم الحالي؛ يتم عرض CPD والطلبات كمصادر تشغيلية قريبة.',
    endpoints: [
  ...
  '/rpl/accreditation': {
    title: 'الاعتماد والشهادات',
    eyebrow: 'RPL',
    icon: BadgeCheck,
    description: 'يتم ربط الشاشة بالخبراء وطلبات البرامج إلى حين توفر عقود شهادات RPL مستقلة.',
    endpoints: [
      { label: 'طلبات البرامج', request: () => fetchAdminApplications({ per_page: 10 }) },
      { label: 'الخبراء', request: () => fetchAdminExperts({ per_page: 10 }) },
    ],
  ...
  '/rpl/appeals': {
    ...
    eyebrow: 'الحوكمة',
    icon: Scale,
    description: 'لا يوجد endpoint تظلمات مستقل في ملف التسليم؛ يتم عرض سجل التدقيق كمرجع حوكمة.',
    endpoints: [{ label: 'سجل التدقيق', request: () => fetchAuditLogs({ per_page: 10 }) }],
  },
  '/standards': {
    title: 'معايير الكفاءة',
    eyebrow: 'المعايير',
    icon: Sparkles,
    description: 'تصنيفات الخبرة الحالية هي أقرب taxonomy متوفر في API.',
    endpoints: [{ label: 'تصنيفات الخبرة', request: () => fetchAdminExpertiseCategories({ per_page: 10 }) }],
  },
  '/assessors': {
    title: 'المقيّمون والمدرّبون',
    eyebrow: 'شبكة الخبراء',
    icon: GraduationCap,
    description: 'إدارة الخبراء وتصنيفاتهم واستشاراتهم.',
    endpoints: [
      { label: 'الخبراء', request: () => fetchAdminExperts({ per_page: 10 }) },
      { label: 'الاستشارات', request: () => fetchAdminConsultations({ per_page: 10 }) },
    ],
  ...
  '/committees': {
    title: 'اللجان',
    eyebrow: 'الحوكمة المؤسسية',
    icon: Landmark,
    description: 'لا يوجد endpoint لجان مستقل في التسليم؛ يتم عرض سجل التدقيق كمرجع حوكمة.',
    endpoints: [{ label: 'سجل التدقيق', request: () => fetchAuditLogs({ per_page: 10 }) }],
  },
  '/quality': {
    title: 'ضمان الجودة',
    eyebrow: 'الجودة',
    icon: ShieldCheck,
    description: 'ربط مراجعات CPD وسجل التدقيق كمصادر متابعة جودة متاحة.',
    endpoints: [
      { label: 'سجل CPD', request: () => fetchAdminCpd({ per_page: 10 }) },
