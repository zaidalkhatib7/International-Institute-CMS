...
const copyByLanguage = {
  ar: {
    ...
    strictTitle: 'حدود الخدمة الصارمة', strictHint: 'لا يجوز لـGemini أو للمدير خلط RPL بالمؤهلات المهنية.',
    rpl: 'الاعتراف بالخبرات المهنية RPL', rplHint: 'تقييم الخبرة والأدلة ثم تحديد مستوى الاعتماد وبرامج سد الفجوات المناسبة.',
    qualifications: 'المؤهلات المهنية', qualificationsHint: 'نظام أكاديمي منفصل تمامًا؛ حاملو البكالوريوس أو ما يعادله لا يدخلون RPL.',
  ...
  en: {
    ...
    strictTitle: 'Strict service boundary', strictHint: 'Neither Gemini nor an administrator may mix RPL with Professional Qualifications.',
    ...
    qualifications: 'Professional Qualifications', qualificationsHint: 'A completely separate academic-entry system; bachelor/equivalent holders do not enter RPL.',
  ...
  nl: {
    ...
    strictTitle: 'Strikte dienstgrens', strictHint: 'Gemini en beheerders mogen RPL niet mengen met professionele kwalificaties.',
    ...
    qualifications: 'Professionele kwalificaties', qualificationsHint: 'Een volledig apart academisch traject; houders van een bachelor of equivalent nemen niet deel aan RPL.',
