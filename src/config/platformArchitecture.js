const text = {
  ar: {
    ...
    workspaces: [
      ...
      ['finance', 'النظام المالي', 'الفواتير والمدفوعات والاشتراكات والكوبونات والتقارير المالية.', 'finance', ['الفواتير', 'المدفوعات', 'الاشتراكات', 'الكوبونات', 'التقارير المالية'], true],
      ['administration', 'الإدارة', 'إدارة المنصة والمرجعيات والصلاحيات والبرامج واللجان والتقارير.', 'administration', ['المستخدمون والصلاحيات', 'معايير الكفاءة', 'أدوات التقييم', 'البرامج والحقائب', 'اللجان', 'إعدادات النظام']],
    ],
    quickActions: [
  ...
  en: {
    accreditationLevels: ['Foundation', 'Advanced', 'Expert'],
    ...
    workspaces: [
      ...
      ['finance', 'Finance System', 'Invoices, payments, subscriptions, coupons, and financial reports.', 'finance', ['Invoices', 'Payments', 'Subscriptions', 'Coupons', 'Financial reports'], true],
      ['administration', 'Administration', 'Platform references, permissions, programs, committees, reports, and settings.', 'administration', ['Users and permissions', 'Competency standards', 'Assessment tools', 'Programs and kits', 'Committees', 'System settings']],
    ],
    quickActions: [
  ...
  nl: {
    accreditationLevels: ['Basis', 'Gevorderd', 'Expert'],
    ...
    workspaces: [
      ...
      ['finance', 'Financieel systeem', 'Facturen, betalingen, abonnementen, coupons en financiële rapporten.', 'finance', ['Facturen', 'Betalingen', 'Abonnementen', 'Coupons', 'Financiële rapporten'], true],
      ['administration', 'Beheer', 'Platformreferenties, rechten, programma’s, commissies, rapporten en instellingen.', 'administration', ['Gebruikers en rechten', 'Competentiestandaarden', 'Beoordelingstools', 'Programma’s en pakketten', 'Commissies', 'Systeeminstellingen']],
    ],
    quickActions: [
