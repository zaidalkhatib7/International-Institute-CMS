  ...
  return (
    <div className={cn('w-full', className)}>
      ...
      <div className="relative">
        <select ref={ref} id={controlId} aria-invalid={error ? true : undefined} aria-describedby={props['aria-describedby'] || descriptionId} className={cn('w-full appearance-none rounded-[var(--radius-md)] border border-[var(--color-border)] bg-white px-4 py-3 pe-11 text-[var(--color-text)] outline-none transition-all hover:border-[var(--color-border-strong)] focus:border-[var(--color-primary)] focus:ring-4 focus:ring-[rgba(22,153,214,0.11)]', error && 'border-[var(--color-danger)]', inputClassName)} {...props}>{children}</select>
