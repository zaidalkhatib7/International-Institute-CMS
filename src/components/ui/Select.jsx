  ...
  return (
    <div className={cn('w-full', className)}>
      ...
      <div className="relative">
        <select ref={ref} className={cn('w-full appearance-none rounded-[var(--radius-md)] border border-[var(--color-border)] bg-white px-4 py-3 pe-11 text-[var(--color-text)] outline-none transition-all focus:border-[var(--color-primary)]', error && 'border-[var(--color-danger)]', inputClassName)} {...props}>{children}</select>
